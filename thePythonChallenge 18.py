...
import cookielib, re, urllib, bz2, urllib2
...
#using again the python app developped at step 13, and asking for the phone of Mozart father, that is Leoplod, we finally receive:
# no! i mean yes! but ../stuff/violin.php. 
#so next URL is: http://huge:file@www.pythonchallenge.com/pc/stuff/violin.php
...
# print (inside an HTML page):
#oh well, don't you dare to forget the balloons.
#next level is at balloons.html though!
